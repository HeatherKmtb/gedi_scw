    ...
    def gen_command_info(self, **kwargs):
        ...
        for tile_name in tile_names:
            ...
            if (not os.path.exists(out_vec_file)) and os.path.exists(in_vec_file):
                ...
                c_dict['join_vec_file'] = kwargs['join_vec_file']
                c_dict['join_vec_lyr'] = kwargs['join_vec_lyr']
                c_dict['out_vec_file'] = out_vec_file
                self.params.append(c_dict)


    def run_gen_commands(self):
        # Join the WWF Ecoregions
        self.gen_command_info(
            ...
            join_vec_file='/scratch/a.hek4/WWF_Ecoregions/wwf_terr_ecos.shp',
            join_vec_lyr='wwf_terr_ecos',
            out_gedi_dir='/scratch/a.hek4/gedi_files_2021_12_16/data/gedi_tiles_stats_s1')

        # If you want to join other vector layer then copy the self.gen_command_info call
        # and change the input in_gedi_dir and out_gedi_dir for the appropriate gedi data
        # and then update the join_vec_file and join_vec_lyr variables for the layer to be
        # joined.
