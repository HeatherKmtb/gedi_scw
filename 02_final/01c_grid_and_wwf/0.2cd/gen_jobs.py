...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gedi_file in gedi_files:
            ...
            if (not os.path.exists(out_csv_file)):
                ...
                c_dict['out_fig_dir'] = '/scratch/a.hek4/results/1_deg/figs/wwf_grid/0.2/'
    ...
    def run_gen_commands(self):
        self.gen_command_info(
            ...
            out_fig_dir='/scratch/a.hek4/results/1_deg/figs/wwf_grid/0.2/',
            out_csv_dir='/scratch/a.hek4/results/1_deg/csvs/wwf_grid/0.2/')
