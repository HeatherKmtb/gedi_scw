...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gedi_file in gedi_files:
            ...
            if (not os.path.exists(out_csv_file)):
                ...
                c_dict['out_fig_dir'] = '/scratch/a.hek4/results/1_deg/figs/cover/'
    ...
    def run_gen_commands(self):
        self.gen_command_info(
            ...
            out_fig_dir='/scratch/a.hek4/results/1_deg/figs/cover/',
            out_csv_dir='/scratch/a.hek4/results/1_deg/csvs/cover/')
            #out_gpkg_dir='/scratch/a.hek4/data/1_deg_q/11-season_with_cover/')
