...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gedi_file in gedi_files:
            ...
            if (not os.path.exists(out_csv_file)):
                ...
                c_dict['out_fig_dir'] = '/scratch/a.hek4/results/5km/figs/'
    ...
    def run_gen_commands(self):
        self.gen_command_info(
            gedi_tiles='/scratch/a.hek4/results/5km/1-initial_csvs/*.csv',
            out_fig_dir='/scratch/a.hek4/results/5km/figs/',
            out_csv_dir='/scratch/a.hek4/results/5km/csvs/')
