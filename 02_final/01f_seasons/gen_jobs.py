...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        if not os.path.exists(kwargs['out_gpkg_dir']):
            os.mkdir(kwargs['out_gpkg_dir'])    
        ...
        for gedi_file in gedi_files:
            ...
            if (not os.path.exists(out_csv_file)):
                ...
                c_dict['out_fig_dir'] = '/scratch/a.hek4/results/1_deg/figs/summer/'
    ...
    def run_gen_commands(self):
        self.gen_command_info(
            gedi_tiles='/scratch/a.hek4/data/1_deg_q/8-merged/*summer.gpkg',
            out_fig_dir='/scratch/a.hek4/results/1_deg/figs/summer/',
            out_csv_dir='/scratch/a.hek4/results/1_deg/csvs/summer/',
            out_gpkg_dir='/scratch/a.hek4/data/1_deg_q/10-season_with_cd/')
            #ALSO CHANGE QUARTER AND OUT_FIG_DIR IN C_DICT ABOVE
        
        self.pop_params_db()

        self.create_slurm_sub_sh("join_lc", 8224, '/scratch/a.hek4/logs', run_script="exe_analysis.sh",
