...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(
            gedi_tiles='/scratch/a.hek4/data/5.gedi_base_tiles/GEDI02_B_2019_Q4/*.gpkg',
            out_dir='/scratch/a.hek4/data/1_deg_q/1.filter_for_quality')


        self.pop_params_db()
        self.create_slurm_sub_sh("filter_for_quality", 8224, '/scratch/a.hek4/logs', run_script="exe_analysis.sh",
