...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gedi_file in gedi_files:
            ...
            out_file = os.path.join(kwargs['out_dir'], f'{basename}_2020_Q1.gpkg')
    ...
    def run_gen_commands(self):
        self.gen_command_info(
            gedi_tiles='/scratch/a.hek4/data/1_deg_q/7.merged_layers/GEDI02_B_2020_Q1/*.gpkg',
            out_dir='/scratch/a.hek4/data/1_deg_q/7b-renamed/')
